...
hip_angle_r =     [2036, 2147, 2147]
knee_angle_r =    [2036, 2602, 2602]
ankle_angle_r =   [2036, 1581, 1581]
ankle_twist_angle_r = [2036, 2036, 2036]

rotation_angle_l =     [2036, 2036, 2036]
abduction_angle_l =    [2036, 2036, 2036]
hip_angle_l =      [2036, 2412, 2412]
knee_angle_l =     [2036, 2721, 2721]
ankle_angle_l =    [2036, 1727, 1727]
...
while (j < 1):
    while (pres_time < total_time):
        ...
        i += 1
        sleep(total_time/len(abduction_angle_r))
    i = -1
    pres_time = 0.0
    j += 1
