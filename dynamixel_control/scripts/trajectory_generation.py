...
# Hand funk
# right_1 = [2036, 1988, 2036, 3080, 2036]
# right_2 = [2036, 3098, 2036, 2078, 2036]
# right_3 = [2036, 2117, 2036, 1073, 2036]
# right_4 = [2036, 2177, 2036, 3064, 2036]
# right_5 = [2036, 2093, 2036, 2173, 2036]

# left_1 = [2036, 1039, 2036, 2066, 2036]
# left_2 = [2036, 2085, 2036, 3104, 2036]
# left_3 = [2036, 3039, 2036, 2023, 2036]
# left_4 = [2036, 1105, 2036, 2033, 2036]
# left_5 = [2036, 2039, 2036, 2019, 2036]
# head =   [2036, 2559, 2036, 1620, 2036]
