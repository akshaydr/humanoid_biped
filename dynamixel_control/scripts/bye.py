...
def home():
	    time.sleep(3)
            y = np.array([0.0, 0.0,-.11, 0.0, 0.0, 0.0, 0.0, 3.106904956141999, 0.7249140681209508, -1.657102471669158, 0, 0])
    	    motor(y)
            time.sleep(2)
            y = np.array([0.0, 0.0, -.11, 0.0, 0.0, 0.0, 0.0, 3.106904956141999, 0.7249140681209508, -1.657102471669158, 1.0010651880190242,     -4.986432334408164e-05])
            motor(y)
            time.sleep(1)
	    engine = pyttsx3.init()
	    ...
	    engine.runAndWait()
            for i in range (0,3):
                ...
                motor(y)
                time.sleep(1)
        	y1 = np.array([0.0, 0.0, -.11, 0.0, 0.0, 0.0, 0.0, 3.1069285201570485, 0.7250440794013906, -1.6571148588540032, 0.34529520964641125, -8.065526997670532e-05])
        	motor(y1)
        	time.sleep(1)
