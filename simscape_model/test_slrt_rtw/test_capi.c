...
static const rtwCAPI_Signals rtBlockSignals[] = {
   ...
   */
  { 0, 0, TARGET_STRING("u1_value /Output"),
...
static const rtwCAPI_BlockParameters rtBlockParameters[] = {
   ...
   */
  { 1, TARGET_STRING("u1_value /Constant"),
    TARGET_STRING("Value"), 0, 0, 0 },

  { 2, TARGET_STRING("u1_value /Look-Up Table1"),
...
static void* rtDataAddrMap[] = {
  &test_B.Output,                      /* 0: Signal */
  &test_P.Constant_Value,              /* 1: Block Parameter */
  &test_P.LookUpTable1_bp01Data[0],    /* 2: Block Parameter */
  &test_P.u1[0],                       /* 3: Model Parameter */
};
...
void test_InitializeDataMapInfo(void)
{
  ...
  test_M->DataMapInfo.mmi.InstanceMap.rtpAddress = rtmGetDefaultParam(test_M);
  test_M->DataMapInfo.mmi.staticMap->rtpSize = sizeof(P_test_T);
