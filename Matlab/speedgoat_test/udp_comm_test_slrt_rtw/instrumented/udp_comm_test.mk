...
MODEL           = udp_comm_test
MODULES         = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c udp_comm_test.c udp_comm_test_capi.c udp_comm_test_data.c udp_comm_test_xcp.c udp_comm_test_xcp_TET.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = udp_comm_test.mk
...
S_FUNCTIONS     = asciidecode.c asciiencode.c slrtIPConfig.c slrtUDPReceive.c slrtUDPSend.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = udp_comm_testlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = udp_comm_test_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\udp_comm_test_slrt_rtw
