...
y1 = trajectory_equation(0,0,  step_length/2,4,  step_length,0, h,samples);
...
right_rotation_1 = linspace(smiData.RevoluteJoint(10).Rz.Pos, -tr + smiData.RevoluteJoint(10).Rz.Pos, 10);
right_rotation_2 = linspace(smiData.RevoluteJoint(10).Rz.Pos, smiData.RevoluteJoint(10).Rz.Pos, 0);
right_rotation_3 = linspace(smiData.RevoluteJoint(10).Rz.Pos - tr, smiData.RevoluteJoint(10).Rz.Pos, 10);
right_rotation_4 = linspace(smiData.RevoluteJoint(10).Rz.Pos, smiData.RevoluteJoint(10).Rz.Pos, samples);
...
left_rotation_1 = linspace(smiData.RevoluteJoint(9).Rz.Pos,smiData.RevoluteJoint(9).Rz.Pos, samples);
left_rotation_2 = linspace(smiData.RevoluteJoint(9).Rz.Pos,  tr + smiData.RevoluteJoint(9).Rz.Pos, 10);
left_rotation_3 = linspace(smiData.RevoluteJoint(9).Rz.Pos, smiData.RevoluteJoint(9).Rz.Pos, 0);
left_rotation_4 = linspace(smiData.RevoluteJoint(9).Rz.Pos + tr, smiData.RevoluteJoint(9).Rz.Pos, 10);
...
right_knee_twist = right_knee_twist - smiData.RevoluteJoint(8).Rz.Pos;
...
left_knee_twist = left_knee_twist - smiData.RevoluteJoint(6).Rz.Pos;
