...
MODEL           = dynamixel_control
MODULES         = rt_matrx.c rt_printf.c rt_logging.c dynamixel_control.c dynamixel_control_capi.c dynamixel_control_data.c dynamixel_control_xcp.c dynamixel_control_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c fiforeadwrite.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = dynamixel_control.mk
...
S_FUNCTIONS     = asciiencode.c sersetupbase.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = dynamixel_controllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = dynamixel_control_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\dynamixel_control_slrt_rtw
