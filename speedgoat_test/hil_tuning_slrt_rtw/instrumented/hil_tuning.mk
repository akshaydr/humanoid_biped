...
MODEL           = hil_tuning
MODULES         = rt_matrx.c rt_printf.c rt_logging.c hil_tuning.c hil_tuning_capi.c hil_tuning_data.c hil_tuning_xcp.c hil_tuning_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = hil_tuning.mk
...
MODELLIB                  = hil_tuninglib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = hil_tuning_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\hil_tuning_slrt_rtw
