...
os.system("python /home/ajit2/catkin_ws/src/humanoid_biped/dynamixel_control/scripts/gestures/single_hand_start.py")
...
os.system("python /home/ajit2/catkin_ws/src/humanoid_biped/dynamixel_control/scripts/gestures/single_hand_stop.py")
