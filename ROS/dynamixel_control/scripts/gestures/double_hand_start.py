...
# Hand double
right_1 = [2036, 3144, 3144]
right_2 = [2036, 2101, 2101]
right_3 = [2036, 1155, 1155]
right_4 = [2036, 2352, 2352]
right_5 = [2036, 1788, 1788]

left_1 = [2036, 900, 900]
left_2 = [2036, 2133, 2133]
left_3 = [2036, 3054, 3054]
left_4 = [2036, 1722, 1722]
left_5 = [2036, 2298, 2298]
