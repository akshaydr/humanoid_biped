...
right_hip = linspace(right_hip(1), right_hip(1), samples*3);
right_knee = linspace(right_knee(1), right_knee(1), samples*3);
right_ankle = linspace(right_ankle(1), right_ankle(1), samples*3);
...
left_hip = linspace(left_hip(1), left_hip(1), samples*3);
left_knee = linspace(left_knee(1), left_knee(1), samples*3);
left_ankle = linspace(left_ankle(1), left_ankle(1), samples*3);
