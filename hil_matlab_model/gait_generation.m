...
right_knee_1 = smiData.RevoluteJoint(3).Rz.Pos - right_knee_1;
right_knee_2 = smiData.RevoluteJoint(3).Rz.Pos - right_knee_2;
...
%% Left Leg joints
left_hip_1 = left_hip_1 + smiData.RevoluteJoint(4).Rz.Pos + 270;
left_hip_2 = left_hip_2 + smiData.RevoluteJoint(4).Rz.Pos + 270;
left_hip = [flip(left_hip_1) left_hip_2];

left_knee_1 = smiData.RevoluteJoint(8).Rz.Pos + left_knee_1;
left_knee_2 = smiData.RevoluteJoint(8).Rz.Pos + left_knee_2;
...
left_abduction_3 = linspace(smiData.RevoluteJoint(5).Rz.Pos, smiData.RevoluteJoint(5).Rz.Pos, 0);
